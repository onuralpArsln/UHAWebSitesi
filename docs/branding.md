...
2. `templates/layouts/base.njk` outputs CSS variables:
   ...
   ```
3. CSS files (e.g., `public/css/header.css`, `public/css/footer.css`, `public/css/widgets.css`) reference those variables everywhere.
4. Header/footer templates show uploaded logos if paths exist, otherwise fall back to the site name text.
